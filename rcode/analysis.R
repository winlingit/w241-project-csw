...
t.test(dt.atgx$responded ~ dt.atgx$treat)$p.value
...
# stargazer(m5.atg, m6.atg, m7.atg, m8.atg, type = 'text', title = 'Regression Analysis for ATG Feedback Survey Experiment excluding Americas')
...
t.test(dt.ptgx$responded ~ dt.ptgx$treat)$p.value
